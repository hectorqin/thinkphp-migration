...
class Rollback extends Migrate
{
    ...
    protected function configure()
    {
        $this->setName('migrate:rollback')
             ...
             ->addOption('--dry-run', '-x', InputOption::VALUE_REQUIRED, 'Dump query to standard output instead of executing it')
             ->addOption('--fake', null, InputOption::VALUE_REQUIRED, 'Mark any migrations selected as run, but don\'t actually execute them')
             ->setHelp(<<<EOT
The <info>migrate:rollback</info> command reverts the last migration, or optionally up to a specific version

<info>php console migrate:rollback -e default</info>
<info>php console migrate:rollback -e default -t 20111018185412</info>
<info>php console migrate:rollback -e default -d 20111018</info>
<info>php console migrate:rollback -e default -v</info>
