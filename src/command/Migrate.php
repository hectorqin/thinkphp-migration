...
use Phinx\Util\Util;
use think\migration\Input;
use think\migration\Output;
...
abstract class Migrate extends Command
{
    ...
    protected function getPath()
    {
        ...
        return Env::get('root_path') . $options['paths']['migrations'];
    }
        ...
        if (null === $this->migrations) {
            ...
            foreach ($phpFiles as $filePath) {
                if (Util::isValidMigrationFileName(basename($filePath))) {
                    ...
                    // instantiate it
                    $migration = new $class(null, $version, new Input($this->input), new Output($this->output));
